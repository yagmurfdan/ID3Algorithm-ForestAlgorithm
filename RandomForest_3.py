#en düşük feature importance skor olan özellik veri setinden cıkartıldı
...
X = veriseti.drop(['sirket','begenmek'], axis=1)
y = veriseti['sirket']

# eğitim ve test veri setleri oluşturuldu
X_train, X_test, y_train, y_test = train_test_split(X, y, test_size = 0.30, random_state = 42)

encoder = ce.OrdinalEncoder(cols=['ulke','yil', 'izleyici','money','yapimci_sayisi','imdb'])    # sözel bilgiler sayısal bilgilere dönüştürüldü
