#en düşük feature importance skora sahip 2 özellik çıkartıldı
...
X = veriseti.drop(['sirket','begenmek','yil'], axis=1)
y = veriseti['sirket']
...
encoder = ce.OrdinalEncoder(cols=['ulke','izleyici','money','yapimci_sayisi','imdb'])    # sözel bilgiler sayısal bilgilere dönüştürüldü
